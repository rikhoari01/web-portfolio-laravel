    ...
    <main class="main">
            ...
            <div class="home-container container grid">
                <div class="home-data">
                    ...
                    <div class="home-buttons">
                        <a href="{{ asset('/storage/' . $cv->content) }}" class="button button-transparent">Download CV</a>
                        <a href="#about" class="button">About Me</a>
                    </div>
                </div>

                <div class="home-image">
                    <img src="{{ asset('/storage/' . $photo->content) }}" alt="my-image">
                </div>
        ...
        <section id="about" class="about section">
            ...
            <div class="about-container container grid">
                <img src="{{ asset('/storage/' . $about_img->content) }}" alt="about-me" class="about-img">
                ...
                <div class="about-data">
                    <div class="about-info">
                        <div class="about-card">
                            ...
                            <span class="description">1 Years Working</span>
                        </div>
                        <div class="about-card">
                            <i class="bx bx-briefcase-alt icon"></i>
                            <h3 class="title">Completed</h3>
                            <span class="description">5+ Projects</span>
                        </div>
                        <div class="about-card">
        ...
        <section id="works" class="work section">
            ...
            <div class="works-container container grid">
                ...
                <div class="works-card mix {{ $w->work_category }}">
                    <img src="{{ asset('/storage/' . $w->work_img) }}" alt="{{ $w->work_title }}" class="works-img">
